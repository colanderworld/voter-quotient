    ...
    <Main align="center">
      <Box width={{ max: "800px" }} fill="horizontal" pad="small">
        ...
        <Text size="medium" textAlign="start">
          ...
          informed about key local elections and the effects of those elections
          on the criminal justice system.
          <br />
          <br />
          This is a beta product for the 2020 election. We appreciate any and
          all feedback.
        </Text>
        <Heading
          style={{ fontSize: "5em", fontFamily: "IBM Plex Mono" }}
        ...
        <Text size="medium" textAlign="start">
          ...
          much as possible, we will respect and respond to your privacy
          requests. DontWait.Vote does not explicitly use, transfer, sell, or
          monetize any collected personal information for any commercial
          purposes outside of DontWait.Vote.
          <br />
          <br />
          To understand who utilizes our site, we employ Netlify Analytics,
          which collects service usage data. You can read their data policies
          here. We do not advertise on this site, nor do we serve any cookies
          for any purpose.
          <br />
          <br />
          Though use of the website requires the input of a user’s address, we
          do not store that information, nor sell and/or further distribute it
          in any way. We do not employ any user login system or payment
          integration. Thus, we do not store any passwords or tokens from other
          services with highly-sensitive information. DontWait.Vote is a
          statically-generated site. Our service is the same for every user.
          Input addresses are never stored.
        </Text>
        <Heading
          style={{ fontSize: "5em", fontFamily: "IBM Plex Mono" }}
          margin={{ top: "xlarge" }}
        ...
        <Text size="medium" textAlign="start">
          ...
          owned by Eli Cohen and are protected by international copyright,
