...
import { Box, Text, ResponsiveContext, Heading, Accordion, AccordionPanel } from 'grommet'
				...
				<Accordion width='700px'>
					<AccordionPanel
						...
						<Box pad={{ top: 'small', bottom: 'large' }} gap='small'>
							...
							<Text size='16px'>
								But in more details, here's some really good detail. Like a lot of other
								things that you should definitely be aware of and pay attention to be cause
								there is a lot of good tuff for yuou to know woooo!
							</Text>
						</Box>
					</AccordionPanel>
					<AccordionPanel
					...
					<AccordionPanel
						...
						label={
							<Box margin={size === 'small' && { horizontal: 'small' }}>
								<Text weight='bold'>I see a mistake. Where do I report it?</Text>
							</Box>
						}>
						<Box pad={{ top: 'small', bottom: 'large' }} gap='small'>
							<Text>
